...
<body>
    ...
    <?php if ( empty($_POST['btn_submit']) && !empty($_SESSION['success_message']) ): ?>
        ...
        <?php unset($_SESSION['success_massage']); ?>
    <?php endif; ?>
    ...
    <form method="post">
        <div>
            ...
            <input type="text" id="view_name" name="view_name" value="<?php if (!empty($_SESSION['view_name'])) { echo htmlspecialchars( $_SESSION['view_name'], ENT_QUOTES, 'UTF-8'); } ?>">
        </div>
        <div>
